...
2. Run **first-time setup** from the repo root (see [README.md](README.md)):
   - Windows: `setup.bat`
   - macOS / Linux: `chmod +x setup.sh dreamforge.sh DreamForge.command && ./setup.sh`
   - On Apple Silicon: use **arm64** Python and Node (see [docs/TROUBLESHOOTING.md](docs/TROUBLESHOOTING.md#macos-setup-setupsh))
