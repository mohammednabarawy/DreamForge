...
parser.add_argument("--gpu-device-id", type=int, default=None, metavar="DEVICE_ID",
                    help="CUDA device ID (ignored on MPS/Apple Silicon platforms)")
parser.add_argument("--offline", action="store_true", help="Skip update-check during startup.")
parser.add_argument(
    "--setup-only",
    action="store_true",
    help="Install Python deps, clone ComfyUI repos, and download small defaults without starting the web UI.",
)
