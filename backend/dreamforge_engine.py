...
def _free_comfy_vram(*, unload_models: bool = False) -> None:
    ...
    try:
        ...
        if server.is_running():
            ...
            client.free_memory(unload_models=unload_models, free_memory=True)
...
class DreamForgeEngine:
    ...
    def _to_namespace(params: dict) -> SimpleNamespace:
        mapping = {
            ...
            "upscale_tile_width": "upscale_tile_width",
            "upscale_tile_height": "upscale_tile_height",
            "upscale_tile_padding": "upscale_tile_padding",
            "upscale_mask_blur": "upscale_mask_blur",
            "upscale_seam_fix_mode": "upscale_seam_fix_mode",
            "upscale_force_uniform_tiles": "upscale_force_uniform_tiles",
            "upscale_tiled_decode": "upscale_tiled_decode",
            "edit_type": "edit_type",
            "edit_strength": "edit_strength",
            "qwen_edit_mode": "qwen_edit_mode",
            "qwen_image_shift": "qwen_image_shift",
            "qwen_scale_megapixels": "qwen_scale_megapixels",
            "qwen_preserve_resolution": "qwen_preserve_resolution",
            "qwen_preserve_megapixels": "qwen_preserve_megapixels",
            ...
            "inpaint_mask_grow_by": "inpaint_mask_grow_by",
            "inpaint_intent": "inpaint_intent",
            "edit_task": "edit_task",
            "custom_tool_id": "custom_tool_id",
            "outfit_auto_mask": "outfit_auto_mask",
            "outfit_transfer_regions": "outfit_transfer_regions",
            "inpaint_additional_prompt": "inpaint_additional_prompt",
            "inpaint_hard_mask": "inpaint_hard_mask",
            ...
            "portrait_shot": "portrait_shot",
            "portrait_age": "portrait_age",
            "portrait_expression": "portrait_expression",
            "portrait_lighting": "portrait_lighting",
            "portrait_skin_detail": "portrait_skin_detail",
            "portrait_eye_detail": "portrait_eye_detail",
            "portrait_pose_strength": "portrait_pose_strength",
            "portrait_depth_strength": "portrait_depth_strength",
        ...
        data = {
            ...
            "upscale_tile_width": None,
            "upscale_tile_height": None,
            "upscale_tile_padding": None,
            "upscale_mask_blur": None,
            "upscale_seam_fix_mode": None,
            "upscale_force_uniform_tiles": None,
            "upscale_tiled_decode": None,
            "edit_type": "auto",
            "edit_strength": None,
            "qwen_edit_mode": "auto",
            "qwen_image_shift": None,
            "qwen_scale_megapixels": None,
            "qwen_preserve_resolution": None,
            "qwen_preserve_megapixels": None,
            ...
            "edit_task": None,
            "custom_tool_id": None,
            "outfit_auto_mask": False,
            "outfit_transfer_regions": None,
            "inpaint_additional_prompt": None,
            "inpaint_hard_mask": False,
            ...
            "portrait_lighting": None,
            "portrait_skin_detail": None,
            "portrait_eye_detail": None,
            "portrait_pose_strength": None,
            "portrait_depth_strength": None,
            "cn_strength": None,
            "cn_start": None,
            "cn_stop": None,
            "outpaint_left": 0,
            ...
            "template_id": None,
            "post_upscale": None,
            "post_upscale_enabled": False,
            "automation_id": None,
            "automation_type": None,
            "automation_index": None,
            "automation_total": None,
            "detail_target": None,
            "detail_prompt": None,
            "style": "none",
            "json": True,
