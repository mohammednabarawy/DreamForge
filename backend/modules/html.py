css = """
/* DreamForge brand (assets in backend/html/) */
.gradio-container {
  ...
  background-image: linear-gradient(
    ...
    url('gradio_api/file=html/background.png') !important;
...
progress::-webkit-progress-value {
  background: linear-gradient(90deg, #00aeef, #f7941e) !important;
}
progress::-moz-progress-bar {
  background: linear-gradient(90deg, #00aeef, #f7941e) !important;
}
.dreamforge-brand-bar {
  display: flex;
  align-items: center;
  justify-content: center;
  padding: 10px 12px 4px;
}
.dreamforge-brand-wordmark {
  max-height: 52px;
  width: auto;
