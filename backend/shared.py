...
_HEADLESS_BOOT = os.environ.get("DREAMFORGE_HEADLESS") == "1"

try:
    from transformers import CLIPTokenizer
except Exception:
    CLIPTokenizer = None  # type: ignore[misc, assignment]
...
wildcards = None
tokenizer = None
if not _HEADLESS_BOOT and CLIPTokenizer is not None:
    try:
...
models = Models(offline=bool(getattr(args, "offline", False)) or _HEADLESS_BOOT)
shared_cache = {}
