### 26.05.12
* Local agent wrapper hardening: headless CLI now supports documented inventory, dry-run, output, manifest, validation, creative-brief, and VRAM profile flags; inventories diffusion_models/unet/text_encoders/GGUF; routes Flux/HiDream/Qwen-Image/Edit model families; and documents the 2026-05-21 RTX 5060 Ti evaluation.
...
### 1.27.0
* Advance prompt editing - See [Wiki](https://github.com/runew0lf/DreamForge/wiki/Features#advanced-prompt-editing)
...
### 1.4.2
* change dreamforgeversion.py to version.py for easier updating
